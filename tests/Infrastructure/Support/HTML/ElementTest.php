...
class ElementTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $element = new \Extly\Infrastructure\Support\HtmlAsset\HTML\Element('a', 'Documents', ['href' => '/documents']);
    ...
    {
        $element = new \Extly\Infrastructure\Support\HtmlAsset\HTML\Element('input', null, ['type' => 'text']);
